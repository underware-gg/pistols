...
export async function main(botContext: BotContext) {
  console.log(chalk.yellow(botContext.emoji.repeat(10)));
  console.log(chalk.yellow(`${botContext.emoji} ${botContext.description.name}`));
  console.log(chalk.yellow(botContext.emoji));

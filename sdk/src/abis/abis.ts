...
import katana_account from './katana_account.json'
import argentx_account from './argentx_account.json'
import braavos_account from './braavos_account.json'
import erc20_legacy from './erc20_legacy.json'
import erc20_lords from './erc20_lords.json'
...
export const braavos_account_abi: Abi = braavos_account
export const erc20_legacy_abi: Abi = erc20_legacy
export const erc20_lords_abi: Abi = erc20_lords

...
export const PACK_TYPES: type_PACK_TYPES = {
  Unknown: {
    id: 'Unknown',
    name: 'Unknown',
    image_file_closed: '/tokens/Unknown.jpg',
    image_file_open: '/tokens/Unknown.jpg',
    can_purchase: false,
    price_lords: 0n,
    quantity: 0,
    contents: 'Void',
  ...
  StarterPack: {
    id: 'StarterPack',
    name: 'Starter Pack',
    image_file_closed: '/tokens/StarterPack.jpg',
    image_file_open: '/tokens/StarterPack.jpg',
    can_purchase: false,
  ...
  GenesisDuelists5x: {
    ...
    image_file_closed: '/tokens/GenesisDuelists5x.png',
    image_file_open: '/tokens/GenesisDuelists5x.png',
    can_purchase: true,
  ...
  SingleDuelist: {
    id: 'SingleDuelist',
    name: 'Single Duelist',
    image_file_closed: '/tokens/SingleDuelist.jpg',
    image_file_open: '/tokens/SingleDuelist.jpg',
    can_purchase: false,
    price_lords: (10n * CONST.ETH_TO_WEI),
    quantity: 1,

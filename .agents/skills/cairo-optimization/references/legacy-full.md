...
Use `scripts/bounded_int_calc.py` in this skill directory. **Always use CLI — never calculate manually.**

```bash
# Addition: [a_lo, a_hi] + [b_lo, b_hi]
python3 scripts/bounded_int_calc.py add 0 12288 0 12288
# -> BoundedInt<0, 24576>

# Subtraction: [a_lo, a_hi] - [b_lo, b_hi]
python3 scripts/bounded_int_calc.py sub 0 12288 0 12288
# -> BoundedInt<-12288, 12288>

# Multiplication
python3 scripts/bounded_int_calc.py mul 0 12288 0 12288
# -> BoundedInt<0, 150994944>

# Division: quotient and remainder bounds
python3 scripts/bounded_int_calc.py div 0 24576 12289 12289
# -> DivT: BoundedInt<0, 1>, RemT: BoundedInt<0, 12288>

# Custom impl name
python3 scripts/bounded_int_calc.py mul 0 12288 0 12288 --name MulZqImpl
```

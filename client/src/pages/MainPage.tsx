...
function Modals() {
  const { selectedDuelId, selectedDuelistId, selectedPlayerAddress, challengingAddress, challengingDuelistId, walletFinderOpener, duelistSelectOpener } = usePistolsContext()

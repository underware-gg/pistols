...
export function defineContractComponents(world: World) {
  return {
	  ...
	  Duelist: (() => {
	    return defineComponent(
	      world,
	      { address: RecsType.BigInt, name: RecsType.BigInt, profile_pic: RecsType.Number, total_duels: RecsType.Number, total_wins: RecsType.Number, total_losses: RecsType.Number, total_draws: RecsType.Number, total_honour: RecsType.Number, honour: RecsType.Number, villainy: RecsType.Number, trickery: RecsType.Number, virtue: RecsType.Number, timestamp: RecsType.Number },
	      {
	        metadata: {
	          name: "Duelist",

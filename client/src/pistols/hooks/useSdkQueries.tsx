...
import { useSdkGetEntity, PistolsGetQuery, useSdkGet, EntityResult, filterEntitiesByModel } from '@/lib/dojo/hooks/useSdkGet'
...
//   const duelists = useMemo(() => filterEntitiesByModel<models.Duelist>(entities, 'Duelist'), [entities])
...
//     },
//   }), [owner])
//   const { entities, isLoading, refetch } = useSdkGet({ query, enabled })

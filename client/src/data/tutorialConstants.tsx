...
const TUTORIAL_DATA: Record<TutorialParts, TutorialData> = {
  [TutorialParts.DUEL_INFO]: {
    ...
    slides: [{
      imagePath: '/tutorial/duel_info.png',
  ...
  [TutorialParts.PLAYER_INFO]: {
    ...
    slides: [{
      imagePath: '/tutorial/player_info.png',
  ...
  [TutorialParts.DUEL_CONTROLS]: {
    ...
    slides: [{
      imagePath: '/tutorial/duel_controls.png',
  ...
  [TutorialParts.PROGRESS_BUBBLES]: {
    ...
    slides: [{
      imagePath: '/tutorial/progress.png',
  ...
  [TutorialParts.SELECTING_CARDS_SIMPLE]: {
    ...
    slides: [{
      imagePath: '/tutorial/select_simple.png',
  ...
  [TutorialParts.SELECTING_CARDS]: {
    ...
    slides: [{
      imagePath: '/tutorial/select_advanced.png',
  ...
  [TutorialParts.DUEL_CARD_DETAILS]: {
    ...
    slides: [{
      imagePath: '/tutorial/card_details.png',
  ...
  [TutorialParts.DUELIST_INFO]: {
    ...
    slides: [{
      imagePath: '/tutorial/duelist_info.png',
  ...
  [TutorialParts.SHOOT_DODGE_CARDS]: {
    ...
    slides: [{
      imagePath: '/tutorial/shoot_dodge.png',
  ...
  [TutorialParts.TACTIC_CARDS]: {
    ...
    slides: [{
      imagePath: '/tutorial/tactics.png',
  ...
  [TutorialParts.ENVIRONMENT_DECK]: {
    ...
    slides: [{
      imagePath: '/tutorial/environment.png',
  ...
  [TutorialParts.SHOOTING]: {
    ...
    slides: [{
      imagePath: '/tutorial/shooting.png',
  ...
  [TutorialParts.DODGING]: {
    ...
    slides: [{
      imagePath: '/tutorial/dodging.png',
  ...
  [TutorialParts.HIT_CHANCE]: {
    ...
    slides: [{
      imagePath: '/tutorial/hit_chance.png',
  ...
  [TutorialParts.ENVIRONMENT_CARD_DRAW]: {
    ...
    slides: [{
      imagePath: '/tutorial/env_draw.png',
  ...
  [TutorialParts.DUEL_CONCLUSION]: {
    ...
    slides: [{
      imagePath: '/tutorial/conclusion.png',
  ...
  [TutorialParts.DUELIST]: {
    ...
    slides: [{
      imagePath: '/tutorial/duelist.png',
  ...
  [TutorialParts.DUELIST_ARCHETYPE]: {
    ...
    slides: [{
      imagePath: '/tutorial/archetype.png',
  ...
  [TutorialParts.DUEL_SIMPLE_INTRO]: {
    ...
    slides: [{
      imagePath: '/tutorial/simple_intro.png',
  ...
  [TutorialParts.DUEL_FULL_INTRO]: {
    ...
    slides: [{
      imagePath: '/tutorial/full_intro.png',
...
export {
  ...
  TUTORIAL_SCENE_DATA,
  tutorialScenes,
  DuelTutorialLevel as DuelTutorial
}
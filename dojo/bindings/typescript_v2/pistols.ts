// Generated by dojo-bindgen on Fri, 25 Oct 2024 00:41:36 +0000. Do not modify this file manually.
...
// Type definition for `pistols::models::table::TableWager` struct
export interface TableWager {
    table_id: string;
    wager_min: bigint;
    wager_max: bigint;
    fee_pct: number;
...
// Type definition for `pistols::models::coin_config::CoinConfig` struct
...
class DuelistTokenCalls extends BaseCalls {
    ...
    async getTokenMetadata(token_id: U256): Promise<void> {
        try {
            await this.execute("get_token_metadata", [token_id])
        } catch (error) {
            console.error("Error executing getTokenMetadata:", error);
            throw error;
        }
    }
    ...
    async getMetadataPairs(token_id: U256): Promise<void> {
        try {
            await this.execute("get_metadata_pairs", [token_id])
        } catch (error) {
    ...
    async getAttributePairs(token_id: U256): Promise<void> {
        try {
            await this.execute("get_attribute_pairs", [token_id])
        } catch (error) {
    ...
    async dojoInit(minter_address: string, renderer_address: string, treasury_address: string, fee_contract: string, fee_amount: bigint): Promise<void> {
        try {
            await this.execute("dojo_init", [minter_address,
                renderer_address,
                treasury_address,
                fee_contract,
                fee_amount])
    ...
    async setTable(table: TableConfig): Promise<void> {
        try {
            await this.execute("set_table", [props.table.table_id,
                    ...
                    props.table.fee_contract_address,
...
type Query = Partial<{
    TableWager: ModelClause<TableWager>;

// Generated by dojo-bindgen on Wed, 10 Apr 2024 21:29:01 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function actions() {
        ...
        return {
            dojoResource, registerDuelist, createChallenge, replyChallenge, commitAction, revealAction, getPact, hasPact, calcFee, calcHitBonus, calcHitPenalty, calcHitChances, calcCritChances, calcGlanceChances, calcHonourForAction, getValidPackedActions, packActionSlots, unpackActionSlots
        };
    }
    ...
    function admin() {
        ...
        return {
            initialize, setOwner, setTreasury, setPaused, setCoin, enableCoin, getConfig, getCoin, dojoResource
        };
    }
    ...
    function lords_mock() {
        ...
        return {
            balanceOf, transfer, transferFrom, balanceOf, transferFrom, totalSupply, name, symbol, decimals, dojoResource, initializer, faucet, totalSupply, allowance, approve
        };
    }

...
// Generated by dojo-bindgen on Tue, 6 Aug 2024 23:15:57 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function lords_mock() {
        ...
        return {
            faucet, mint, balanceOf, transferFrom, world, balance_of, transfer, transfer_from, name, symbol, decimals, allowance, approve, totalSupply, total_supply
        };
    }
    ...
    function token_duelist() {
        ...
        return {
            mint, burn, build_uri, totalSupply, tokenByIndex, tokenOfOwnerByIndex, ownerOf, total_supply, token_by_index, token_of_owner_by_index, world, supportsInterface, getApproved, isApprovedForAll, setApprovalForAll, balance_of, transfer_from, safe_transfer_from, get_approved, is_approved_for_all, approve, set_approval_for_all, supports_interface, balanceOf, transferFrom, safeTransferFrom, name, symbol, token_uri, owner_of, tokenURI
        };
    }
    ...
    function actions() {
        ...
        // Call the `validate_commit_message` system with the specified Account and calldata
        const validate_commit_message = async (props: { account: Account, account: bigint, signature: RecsType.BigIntArray, duelId: bigint, roundNumber: bigint, duelistId: bigint }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
                        contractName: contract_name,
                        entrypoint: "validate_commit_message",
                        calldata: [props.account,
                ...props.signature,
                props.duelId,
                props.roundNumber,
        ...
        return {
            world, mint_duelist, update_duelist, create_challenge, reply_challenge, commit_action, reveal_action, get_pact, has_pact, can_join, calc_fee, simulate_chances, get_valid_packed_actions, pack_action_slots, unpack_action_slots, validate_commit_message
        };
    }
    ...
    function admin() {
        ...
        return {
            set_owner, set_treasury, set_paused, set_table, open_table, get_config, get_table, world
        };
    }

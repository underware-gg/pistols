...
export async function setupWorld(provider: DojoProvider) {
    ...
    function actions() {
        ...
        const mint_duelist = async (props: { account: Account, name: bigint, profile_pic_type: number, profile_pic_uri: bigint, initial_archetype: models.Archetype }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
        ...
        const update_duelist = async (props: { account: Account, duelist_id: bigint, name: bigint, profile_pic_type: number, profile_pic_uri: bigint }) => {
            try {
                return await provider.execute(
                    props.account,
                    contract_name,
    ...
    function token_duelist() {
        ...
        return {
            balanceOf, transferFrom, safeTransferFrom, owner_of, total_supply, token_by_index, token_of_owner_by_index, tokenURI, supports_interface, getApproved, isApprovedForAll, setApprovalForAll, world, supportsInterface, totalSupply, tokenByIndex, tokenOfOwnerByIndex, mint, burn, build_uri, name, symbol, token_uri, get_approved, is_approved_for_all, approve, set_approval_for_all, balance_of, transfer_from, safe_transfer_from, ownerOf
        };
    }
    ...
    function lords_mock() {
        ...
        return {
            total_supply, world, balance_of, transfer, transfer_from, name, symbol, decimals, allowance, approve, totalSupply, faucet, mint, balanceOf, transferFrom
        };
    }

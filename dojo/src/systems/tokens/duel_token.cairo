    ...
    impl DuelTokenPublicImpl of super::IDuelTokenPublic<ContractState> {
        ...
        fn reply_duel(ref self: ContractState,
            ...
            if (challenge.state.is_canceled()) {
                ...
                PlayerTrait::check_in(ref store, Activity::ChallengeReplied, challenge.address_b, duel_id.into(), Option::None);
            }
...
//         }
    ...
    impl InternalImpl of InternalTrait {
        fn _spawn_challenge(ref self: ContractState,
            ...
            // events
            PlayerTrait::check_in(ref store, Activity::ChallengeCreated, challenge.address_a, challenge.duel_id.into(), Option::None);

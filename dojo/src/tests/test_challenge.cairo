...
mod tests {
    ...
    fn test_invalid_challenger() {
        let (_world, system, _admin, _lords, _ierc20, owner, other, _bummer, _treasury) = utils::setup_world(true, true);
        let _duel_id: u128 = utils::execute_create_challenge(system, owner, other, MESSAGE_1, WAGER_COIN, 0, 0);
    }
    ...
    fn test_challenge_thyself() {
        let (_world, system, _admin, _lords, _ierc20, owner, _other, _bummer, _treasury) = utils::setup_world(true, true);
        utils::execute_register_duelist(system, owner, PLAYER_NAME, 1);
        let _duel_id: u128 = utils::execute_create_challenge(system, owner, owner, MESSAGE_1, WAGER_COIN, 0, 0);
    }
    ...
    fn test_invalid_code() {
        ...
        let _duel_id: u128 = utils::execute_create_challenge(system, owner, challenged_1, MESSAGE_1, WAGER_COIN, 0, 0);
    }
    ...
    fn test_invalid_expire() {
        ...
        let _duel_id: u128 = utils::execute_create_challenge(system, owner, other, MESSAGE_1, WAGER_COIN, 0, expire_seconds);
    }
    ...
    fn test_challenge_reply_twice() {
        ...
        let expire_seconds: u64 = timestamp::from_days(2);
        let duel_id: u128 = utils::execute_create_challenge(system, owner, other, MESSAGE_1, WAGER_COIN, 0, expire_seconds);
        let _ch = utils::get_Challenge(world, duel_id);
        let (_block_number, _timestamp) = utils::elapse_timestamp(timestamp::from_days(3));
    ...
    fn test_challenge_reply_expired() {
        ...
        let (_block_number, timestamp) = utils::elapse_timestamp(timestamp::from_date(1, 0, 1));
    ...
    fn test_challenge_owner_cancel() {
        ...
        let duel_id: u128 = utils::execute_create_challenge(system, owner, other, MESSAGE_1, WAGER_COIN, 0, expire_seconds);
        let _ch = utils::get_Challenge(world, duel_id);
        let (_block_number, timestamp) = utils::elapse_timestamp(timestamp::from_days(1));
    ...
    fn test_challenge_impersonator() {
        ...
        let duel_id: u128 = utils::execute_create_challenge(system, owner, other, MESSAGE_1, WAGER_COIN, 0, expire_seconds);
        let _ch = utils::get_Challenge(world, duel_id);
        let (_block_number, _timestamp) = utils::elapse_timestamp(timestamp::from_days(1));

...
mod tests {
    ...
    fn _start_new_challenge(world: IWorldDispatcher, actions: IActionsDispatcher, owner: ContractAddress, other: ContractAddress, table_id: felt252) -> (Challenge, u128) {
    ...
    fn test_mint_archetype_snapshot_IRL() {
        ...
        //
        // Simulate!
        let chances_a: SimulateChances = actions.simulate_chances(duelist1.duelist_id, challenge.duel_id, challenge.round_number, 1);
        let chances_b: SimulateChances = actions.simulate_chances(duelist2.duelist_id, challenge.duel_id, challenge.round_number, 10);

...
mod tests {
    ...
    fn test_full_quiz_ok() {
        ...
        //
        // question 1...
        let question_1: QuizQuestion = tester::execute_open_quiz_question(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        ...
        //
        // question 2...
        let question_2: QuizQuestion = tester::execute_open_quiz_question(@sys, OWNER(), event_1.party_id, question_2.question_id, Q2(), Q2_DESC(), Q2_OPTIONS());
    ...
    fn test_full_quiz_admin_ok() {
        ...
        tester::execute_open_quiz_question(@sys, OTHER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
    ...
    fn test_open_quiz_invalid() {
        let mut sys: TestSystems = tester::setup_world(FLAGS::ADMIN | FLAGS::COMMUNITY);
        tester::execute_open_quiz_question(@sys, OWNER(), 123, 1, Q1(), Q1_DESC(), Q1_OPTIONS());
    }
    ...
    fn test_open_quiz_twice() {
        ...
        let event_1: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_1(), EVENT_DESC_1(), 0);
        let question_1: QuizQuestion = tester::execute_create_quiz_question(@sys, OWNER(), event_1.party_id);
        tester::execute_open_quiz_question(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        tester::execute_open_quiz_question(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
    }

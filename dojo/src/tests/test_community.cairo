...
mod tests {
    ...
    fn test_full_quiz_ok() {
        ...
        // event
        let event_1: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_1(), EVENT_DESC_1(), 100, 200);
        let event_2: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_2(), EVENT_DESC_2(), 300, 400);
        ...
        assert_eq!(event_1.timestamps.end, 200, "event_1.timestamp.end");
        assert_eq!(event_2.name, EVENT_NAME_2(), "event_2.name");
        assert_eq!(event_2.description, EVENT_DESC_2(), "event_2.description");
        assert_eq!(event_2.timestamps.start, 300, "event_2.timestamp.start");
        assert_eq!(event_2.timestamps.end, 400, "event_2.timestamp.end");
        ...
        // edit party
        let event_2: QuizParty = tester::execute_edit_quiz_party(@sys, OWNER(), event_2.party_id, EVENT_NAME_3(), EVENT_DESC_3(), 500, 600);
        ...
        assert_eq!(event_2.timestamps.end, 600, "event_3.timestamp.end");
        // question 1+2
        ...
        //
        // question 1...
        let question_1: QuizQuestion = tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        ...
        // players can answer...
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, question_1.question_id, 1);
        tester::execute_answer_quiz(@sys, BUMMER(), event_1.party_id, question_1.question_id, 1);
        tester::execute_answer_quiz(@sys, RECIPIENT(), event_1.party_id, question_1.question_id, 2);
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, question_1.question_id, 4); // can change it...
        // close it
        let question_1: QuizQuestion = tester::execute_close_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, 1);
        ...
        //
        // question 2...
        let question_2: QuizQuestion = tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_2.question_id, Q2(), Q2_DESC(), Q2_OPTIONS());
        ...
        // players can answer...
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, question_2.question_id, 2);
        tester::execute_answer_quiz(@sys, BUMMER(), event_1.party_id, question_2.question_id, 3);
        tester::execute_answer_quiz(@sys, RECIPIENT(), event_1.party_id, question_2.question_id, 1);
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, question_2.question_id, 0); // can erase it...
        // close it
        let question_2: QuizQuestion = tester::execute_close_quiz(@sys, OWNER(), event_1.party_id, question_2.question_id, 1);
    ...
    fn test_full_quiz_admin_ok() {
        ...
        // question 1+2
        let event_1: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_1(), EVENT_DESC_1(), 0, 0);
        let question_1: QuizQuestion = tester::execute_create_quiz_question(@sys, OTHER(), event_1.party_id);
        tester::execute_open_quiz(@sys, OTHER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        tester::execute_close_quiz(@sys, OTHER(), event_1.party_id, question_1.question_id, 1);
    }
    ...
    fn test_open_quiz_twice() {
        ...
        let event_1: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_1(), EVENT_DESC_1(), 0, 0);
        let question_1: QuizQuestion = tester::execute_create_quiz_question(@sys, OWNER(), event_1.party_id);
        tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
    }
    ...
    fn test_close_quiz_twice() {
        ...
        let question_1: QuizQuestion = tester::execute_create_quiz_question(@sys, OWNER(), event_1.party_id);
        tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        tester::execute_close_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, 1);
        tester::execute_close_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, 1);
    }
    ...
    fn test_answer_invalid_quiz() {
        let mut sys: TestSystems = tester::setup_world(FLAGS::ADMIN | FLAGS::COMMUNITY);
        let event_1: QuizParty = tester::execute_create_quiz_party(@sys, OWNER(), EVENT_NAME_1(), EVENT_DESC_1(), 0, 0);
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, 1, 1);
    }
    #[test]
    #[should_panic(expected:('COMMUNITY: Invalid quiz', 'ENTRYPOINT_FAILED'))]
    ...
    fn test_answer_invalid_answer_number() {
        ...
        let question_1: QuizQuestion = tester::execute_create_quiz_question(@sys, OWNER(), event_1.party_id);
        tester::execute_open_quiz(@sys, OWNER(), event_1.party_id, question_1.question_id, Q1(), Q1_DESC(), Q1_OPTIONS());
        tester::execute_answer_quiz(@sys, OTHER(), event_1.party_id, question_1.question_id, 5);
    }
